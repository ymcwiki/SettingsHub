...
- **八大策展主题面板**:相机与 ActionCam、软目标、姓名板、战斗浮动文字、界面 QoL、图形画质(含 RAID* 副本档位)、声音、开发者合规面板。每项有中英双语白话说明、取值范围、作用域徽章、版本注记
- **中英双语**:UI 与 106 条策展说明都有 enUS 和 zhCN/zhTW 两套文案,按客户端语言自动选择;搜索不分语言,中英俗名都命中
...
- **七个非 CVar 域**:键位+ModifiedClick、宏、EditMode 布局(与官方分享串互通)、点击施法、声音静音列表、TTS、console 命令重放
